...
export const PoseImagesProvider = ({ children }: poseImagesProviderProps) => {
    const poseImages = [
        {name: 'なんちゃってヨガ', imageSrc: '/images/original/no_2.jpg', boneImageSrc: '/images/bone/No2_a.jpg'},
        {name: 'さかな~', imageSrc: '/images/original/no_3.jpg', boneImageSrc: '/images/bone/No3_a.jpg'},
        {name: 'コナン', imageSrc: '/images/original/no_1.jpg', boneImageSrc: '/images/bone/No1_a.jpg'},
    ];
